          ...
          <Col className="p-5">
            ...
            <div>
              ...
              <FloatingLabel
                ...
                className="mb-3"
              >
                <Form.Control type="email" placeholder="Username" onChange={(e)=>{setData({...data,email:e.target.value})}} />
              </FloatingLabel>
              ...
              <div className="mt-3 d-flex justify-content-between">
                {
                    ...
                    <button className="btn btn-outline-success" onClick={handleRgister}>Register</button>
                }
